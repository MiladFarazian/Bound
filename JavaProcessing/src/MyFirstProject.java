...
public class MyFirstProject extends PApplet {
    ...
    public void draw() {
        ...
        if (MODE == "MENU") {
            ...
            demoBox5.updateBox();
            demoBox6.updateBox();
            shake = demoBox1.shouldShake() || demoBox2.shouldShake() || demoBox3.shouldShake() || demoBox4.shouldShake()
                    || demoBox5.shouldShake() || demoBox6.shouldShake();
            if (shake) {
                pushMatrix();
        ...
        if (MODE == "PLAYING") {
            ...
            // Boxes
            if (box1.touchingPlayer(playerX) || box2.touchingPlayer(playerX) || box2.touchingPlayer(playerX)
                    || box3.touchingPlayer(playerX) || box4.touchingPlayer(playerX)) {
                MODE = "PAUSE";
            }
            if (score > 5) {
